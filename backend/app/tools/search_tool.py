...
class SearchTool(BaseTool):
    ...
    async def validate(self, payload: dict) -> tuple[bool, str]:
        ...
        if operation not in ("search", "deep_search", "search_papers"):
            return False, f"Invalid operation '{operation}'. Must be: search, deep_search, search_papers"
    ...
    async def _search_papers(self, query: str, num_results: int = 5) -> dict:
        """Academic paper search â€” adds research modifiers to query."""
