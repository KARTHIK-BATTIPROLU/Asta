...
verify:
	...
	@echo "--- Verification Probes ---"
	@echo "Running all docs/verification/probes tests..."
	@python -m pytest docs/verification/probes/ -q && echo "[OK] Verification Probes passed" || (echo "[FAIL] Verification Probes failed" && exit 1)
